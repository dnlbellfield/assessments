...
// five instances of the number 1, 1 will be unused. 2 pair of 1's will be returned
  ...
  identify the neededInteger by calculating the difference between the targetSum and the current integer.
    if neededInteger exists in the list
      ...
      and currentInteger is larger than neededInteger
        ...
        remove [currentInteger, neededInteger] from object for storing integers as keys
    
  return foundPairArray;    
} 
*/
function findPairsNewestTwist(integerArray, targetSum) {
